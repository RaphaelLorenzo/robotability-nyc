...
- `make_maps.py`: creates QA maps for the processed sidewalks and, when available, raw/clamped pedestrian density component maps plus the final weighted score map.
